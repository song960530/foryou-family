package com.foryou.authapi.testUtils;
...
public class RestDocsUtils {
    ...
    public static ResourceSnippetParameters createSuccessDocWithHeader(
            String tag
            , String summary
            , String description
            , String requestSchema
            ...
            , List<FieldDescriptor> requestFieldsDescription
            , List<FieldDescriptor> responseFieldsDescription
            , List<HeaderDescriptorWithType> requestHeaderDescription
    ) {
        return ResourceSnippetParameters.builder()
                .tag(tag)
                .summary(summary)
                ...
                .requestFields((requestFieldsDescription == null) ? Collections.emptyList() : requestFieldsDescription)
                .responseFields((responseFieldsDescription == null) ? Collections.emptyList() : responseFieldsDescription)
                .requestHeaders((requestHeaderDescription == null) ? Collections.emptyList() : requestHeaderDescription)
                .build();
    }
